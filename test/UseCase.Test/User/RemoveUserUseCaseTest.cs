...
public class RemoveUserUseCaseTest
{
    ...
    public async Task ExecuteAsync_ShouldReturnSuccess_WhenUserExists()
    {
        ...
        _writeRepositoryMock.Verify(x => x.SoftDelete(id), Times.Once);
    ...
    public async Task ExecuteAsync_ShouldReturnFailure_WhenUserDoesNotExist()
    {
        ...
        _writeRepositoryMock.Verify(x => x.SoftDelete(id), Times.Never);
